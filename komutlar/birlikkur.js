module.exports = {
	...
	$editMessage[$get[mesaj];$customEmoji[yesiltik] Birlik başarıyla kuruldu.]
	$wait[2s]
	$editMessage[$get[mesaj];$customEmoji[yukleniyo] Birlik üye sınırı ayarlanıyor]
	$wait[2s]
	$editMessage[$get[mesaj];$customEmoji[yukleniyo] Birlik banka hesabı kuruluyor]
	$wait[2s]
	$setGlobalUserVar[birlik;$getGlobalUserVar[birlik;$clientID]$message/;$clientID]
	$wait[2s]
	$let[mesaj;$sendMessage[$customEmoji[yukleniyo] Birlik adı yazılıyor;yes]]
